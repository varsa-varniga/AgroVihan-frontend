...
import { User, Sprout, ChevronRight, Menu, X, BookOpen, Brain, Wallet, Home, Cpu, Users, ShoppingBag, Leaf, FileText, LogOut, Check, ArrowRight, Edit, Save, ArrowLeft } from "lucide-react";
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ color: '#6b7280', margin: '0 0 8px 0', fontSize: '14px' }}>Registered Cultivator</p>
              <div style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: '4px',
        ...
        <div style={{ display: 'grid', gap: '24px' }}>
          <div>
            ...
            <div style={{
              ...
              <InfoField label="Full Name" value={isEditing ? editProfileData.fullName : profileData?.fullName} />
              <InfoField label="Phone Number" value={isEditing ? editProfileData.phone : profileData?.phone} />
              <InfoField label="Aadhaar Last 4" value={isEditing ? editProfileData.aadhaarLast4 : profileData?.aadhaarLast4} />
              <InfoField label="Email" value={isEditing ? editProfileData.email : profileData?.email} />
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <InfoField label="Village/Town" value={isEditing ? editProfileData.village : profileData?.village} />
              <InfoField label="District" value={isEditing ? editProfileData.district : profileData?.district} />
              <InfoField label="State" value={isEditing ? editProfileData.state : profileData?.state} />
              <InfoField label="Pincode" value={isEditing ? editProfileData.pincode : profileData?.pincode} />
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <InfoField label="Land Size" value={isEditing ? editProfileData.landSize : profileData?.landSize} suffix="acres" />
              <InfoField label="Land Type" value={isEditing ? editProfileData.landType : profileData?.landType} />
              <InfoField label="Soil Type" value={isEditing ? editProfileData.soilType : profileData?.soilType} />
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <InfoField label="Income Range" value={isEditing ? editProfileData.incomeRange : profileData?.incomeRange} />
              <InfoField label="Farming Experience" value={isEditing ? editProfileData.experience : profileData?.experience} />
              <InfoField label="Main Crops" value={isEditing ? editProfileData.mainCrops : profileData?.mainCrops} />
            </div>
          </div>
        </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '40px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '12px', color: '#6b7280', margin: 0 }}>Cultivator Portal</p>
                </div>
              </div>
              <button
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1f2937', margin: 0 }}>
                  {activeFeature === 'profile' ? 'My Profile' : 'Cultivator Dashboard'}
                </h1>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', backgroundColor: '#f0fdf4', padding: '8px 16px', borderRadius: '9999px', border: '1px solid #dcfce7' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '12px', color: '#16a34a', margin: 0 }}>Cultivator</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                🎉 Congratulations! You are promoted to Mentor - Share your knowledge with fellow farmers! 🎉
              </div>
            </div>
        ...
        {activeFeature === 'profile' ? (
          ...
          <div style={{ padding: '32px' }}>
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '8px' }}>🌾 Welcome to Your Cultivator Journey!</h2>
              <p style={{ color: '#dcfce7', marginBottom: '24px', lineHeight: '1.6', fontSize: '16px' }}>
                You're now a registered Cultivator! Access learning modules, connect with experts, and grow your farming skills.
            ...
            {/* Features Grid */}
            <h3 style={{ fontSize: '20px', fontWeight: 'bold', color: '#1f2937', marginBottom: '24px' }}>Explore Cultivator Features</h3>
